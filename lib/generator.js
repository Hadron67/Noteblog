...
/** @typedef{{isStatic: boolean, mime: string, handle: (resolve: (s: string) => any, reject: (err) => any) => any}} FileHandler */
    ...
    let server = http.createServer((req, res) => {
        ...
        if (h === null){
            ...
            if (errHandler.E404){
                ...
                errHandler.E404.handle(res, err => err && sendInternalError(res, err));
            }
            else {
                res.setHeader('Content-Type', 'text/plain; charset=utf-8');
